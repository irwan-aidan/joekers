...
cd /usr/bin
wget -O add-ss "https://raw.githubusercontent.com/cybertize/joekers/default/plugins/shadowsocks/add-ss.sh"
wget -O del-ss "https://raw.githubusercontent.com/cybertize/joekers/default/plugins/shadowsocks/del-ss.sh"
wget -O cek-ss "https://raw.githubusercontent.com/cybertize/joekers/default/plugins/shadowsocks/cek-ss.sh"
wget -O renew-ss "https://raw.githubusercontent.com/cybertize/joekers/default/plugins/shadowsocks/renew-ss.sh"
chmod +x add-ss
chmod +x del-ss
chmod +x cek-ss
chmod +x renew-ss
